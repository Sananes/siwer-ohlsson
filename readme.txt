...
Sell Photos - a feature-rich theme that optionally integrates with the Sell Media plugin for selling your photos online.
...
Here is a quick overview of the steps needed to configure the Sell Photos theme. Detailed instructions are listed in the sections below.

1. Configure the Sell Photos theme options at Appearance > Theme Options.
...
Sell Photos will work without the Sell Media plugin active, but, to take advantage of many of the features you see on the theme demo site, you must activate and configure both the Sell Media and Sell Media Advanced Search plugins.

1. Download and install [Sell Media](http://graphpaperpress.com/plugins/sell-media/), [Sell Media Advanced Search](http://graphpaperpress.com/?download=advanced-search) (included in the purchase of this theme).
...
Sell Photos supports eight widgetized areas with the Sell Media plugin activated. Below are screenshots of where the widgetized areas are displayed in this theme:
...
![Homepage and Footer Widgets](https://graphpaperpress.s3.amazonaws.com/images/instructions/stock-photography-widget-home-footer.jpg)
...
![Sell Media Below Single Item](https://graphpaperpress.s3.amazonaws.com/images/instructions/stock-photography-widget-below-single.jpg)
...
![Sidebar](https://graphpaperpress.s3.amazonaws.com/images/instructions/stock-photography-widget-sidebar.jpg)
...
![Sidebar (Sell Media Single Items)](https://graphpaperpress.s3.amazonaws.com/images/instructions/stock-photography-widget-below-item-sidebar.jpg)

The Sell Photos theme and Sell Media plugin add a total of nine additional widgets which you can add to any of the widgetized areas mentioned above. These include:
...
Our themes use WordPress’s custom menus option. These can be created in Appearance > Menus. This theme supports two menu positions: Primary and Secondary. The Primary location appears on the left below the site title. The Secondary location appears at the very bottom of the left sidebar, below the Primary menu. Use Secondary menu to add your social media icons. To add a new menu to your site:
...
You can add social media icons to your menus. This theme supports the following custom icons&mdash;Facebook, Twitter, Vimeo, Google Plus, YouTube, Pinterest, Flickr, LinkedIn, Tumblr.
...
Sell Photos supports the following post formats &mdash; standard, image, gallery, video &mdash;.
...
Sell Photos comes with six page templates (Default, Blog, Collections, Contributors, Dashboard, Lightbox). Each page template serves a specific role in the operation of your site if you have want to sell photos from the Sell Photos theme. You will want to create a new page for each of the following Page Templates (excluding the Default template):
...
6. Lightbox - the page that collects and displays all images saved to the lightbox.

To use a Page Template, create a new Page on the Pages > Add New link. Give your Page a title, such as "Lightbox" and assign the Page to the "Lightbox" Page Template option. The Page Template option appears under the SAVE button in the right-hand sidebar in the Page Attributes metabox. Below is a screenshot of a page using the "Lightbox" page template:

![Lightbox Page Template](https://graphpaperpress.s3.amazonaws.com/images/instructions/page-template.jpg)

### Setting up the Lightbox ###
Setting up the Lightbox is a two step process:

1. Create a new Page called "Lighbox" and assign it to the Lightbox page template (see above) and publish the page (yes, you publish the page with no content at all).
...
[Watch a video tutorial on setting up the Lightbox](https://vimeo.com/66161124)

### Setting up the Cart menu ###

Add your cart page to the Primary Menu. You need to apply a custom CSS class to the Cart menu link. Toggle open the menu link using the arrow icon. If you don't see the CSS Classes option, click the Screen Options link in the top right of the page and make sure the CSS Classes option is checked under the "Show advanced menu options" subheading. Add the css class "cart-menu" to the CSS classes option for the Cart menu link. This special CSS class will append the total amount box right beside the Cart menu link on your site. Below is a screenshot of the Lightbox link menu css class:
