...
function gpp_field_checkbox( $value, $attr ) {
    ...
    if ( isset( $attr['valid_options'] ) ) :
        ...
        foreach( $options as $option_key => $option_value ) : ?>
            <input class="checkbox" id ="<?php echo $option_value['name']; ?>" type="checkbox" <?php if( isset( $value ) && '' != $value ) { checked( in_array( $option_value['name'], $value ) ); }  ?> name="<?php echo gpp_get_current_theme_id(); ?>_options[<?php echo $attr['name']; ?>][]" value="<?php echo esc_attr( $option_key ); ?>">
...
function gpp_field_color( $value, $attr ) { ?>
    ...
    <span class="colorPickerWrapper">
        <input id="<?php echo $attr['name']; ?>" name="<?php echo gpp_get_current_theme_id(); ?>_options[<?php echo $attr['name']; ?>]" class="color-picker" type="text" value="<?php echo $value; ?>" />
    </span>
