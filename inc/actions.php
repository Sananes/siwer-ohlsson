...
function gpp_add_custom_user_profile_fields( $user ) { ?>
	...
	<h3><?php _e( 'Profile Information', 'sell_photos' ); ?></h3>
	<table class="form-table">
	<?php if ( current_user_can( 'manage_options' ) ) { ?>
		<tr>
			<th>
				<label for="contributor"><?php _e( 'Contributor', 'sell_photos' ); ?>
			</label></th>
			<td>
				<fieldset>
					<label for="contributor">
						...
						<?php _e( 'Check to mark as contributor', 'sell_photos' ); ?></label>
				</fieldset>
			</td>
		</tr>
		<tr>
			<th>
				<label for="display_archive"><?php _e( 'Display on contributor page', 'sell_photos' ); ?>
			</label></th>
			<td>
				<fieldset>
					<label for="display_archive">
						...
						<?php _e( 'Check to display on contributor page', 'sell_photos' ); ?></label>
				</fieldset>
			</td>
		</tr>
	<?php } ?>
		<tr>
			<th>
				<label for="position"><?php _e( 'Position', 'sell_photos' ); ?>
			</label></th>
			<td>
				...
				<span class="description"><?php _e( 'Enter your position.', 'sell_photos' ); ?></span>
			</td>
		</tr>

		<tr>
			<th>
				<label for="twitter"><?php _e( 'Twitter', 'sell_photos' ); ?>
			</label></th>
			<td>
				<input type="text" name="twitter" id="twitter" value="<?php echo esc_attr( get_the_author_meta( 'twitter', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Twitter url', 'sell_photos' ); ?></span>
			</td>
		</tr>

		<tr>
			<th>
				<label for="facebook"><?php _e( 'Facebook', 'sell_photos' ); ?>
			</label></th>
			<td>
				<input type="text" name="facebook" id="facebook" value="<?php echo esc_attr( get_the_author_meta( 'facebook', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Facebook url', 'sell_photos' ); ?></span>
			</td>
		</tr>

		<tr>
			<th>
				<label for="googleplus"><?php _e( 'Google +', 'sell_photos' ); ?>
			</label></th>
			<td>
				...
				<span class="description"><?php _e( 'Enter your Google + url', 'sell_photos' ); ?></span>
			</td>
		</tr>

		<tr>
			<th>
				<label for="youtube"><?php _e( 'YouTube', 'sell_photos' ); ?>
			</label></th>
			<td>
				<input type="text" name="youtube" id="youtube" value="<?php echo esc_attr( get_the_author_meta( 'youtube', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your YouTube url', 'sell_photos' ); ?></span>
			</td>
		</tr>

		<tr>
			<th>
				<label for="vimeo"><?php _e( 'Vimeo', 'sell_photos' ); ?>
			</label></th>
			<td>
				<input type="text" name="vimeo" id="vimeo" value="<?php echo esc_attr( get_the_author_meta( 'vimeo', $user->ID ) ); ?>" class="regular-text" /><br />
				<span class="description"><?php _e( 'Enter your Vimeo url', 'sell_photos' ); ?></span>
			</td>
		</tr>
...
add_action( 'wp_head', 'gpp_replace_gallery_shortcode' );