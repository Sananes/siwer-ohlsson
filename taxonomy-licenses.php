	...
	<div id="sell-media-archive" class="sell-media">
		<div id="content" role="main">
			...
			<header class="page-header">
				<h1 class="page-title">
					<a href="<?php print get_post_type_archive_link( 'sell_media_item' ); ?>"><?php $obj = get_post_type_object( 'sell_media_item' ); echo $obj->rewrite['slug']; ?></a> <span class="sep">&raquo;</span> <span><?php _e( 'License Archives', 'sell_photos' ); ?></span> <span class="sep">&raquo;</span> <?php echo single_cat_title( '', false ); ?>
				</h1>
			</header><!-- .page-header -->
